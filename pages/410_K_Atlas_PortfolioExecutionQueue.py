...
from k_atlas.core.portfolio_execution_queue.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Portfolio Execution Queue", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Portfolio Execution Queue")
st.caption("Checkpoint 410 - gerado pelo K-Atlas Local Batch Factory.")
