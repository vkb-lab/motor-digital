...
st.set_page_config(page_title="K-Atlas K-Uni Navigation Runtime Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Navigation Runtime Dashboard")
st.caption("Checkpoint 518 - gerado pelo K-Atlas Local Batch Factory.")
