...
from k_atlas.core.agent_result_evaluator.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Agent Result Evaluator", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Agent Result Evaluator")
st.caption("Checkpoint 139 - gerado pelo K-Atlas Local Batch Factory.")
