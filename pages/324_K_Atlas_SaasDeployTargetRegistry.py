...
from k_atlas.core.saas_deploy_target_registry.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas SaaS Deploy Target Registry", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas SaaS Deploy Target Registry")
st.caption("Checkpoint 324 - gerado pelo K-Atlas Local Batch Factory.")
