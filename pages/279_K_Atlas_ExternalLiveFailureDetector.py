...
from k_atlas.core.external_live_failure_detector.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas External Live Failure Detector", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas External Live Failure Detector")
st.caption("Checkpoint 279 - gerado pelo K-Atlas Local Batch Factory.")
