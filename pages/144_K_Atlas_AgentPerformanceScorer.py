...
st.set_page_config(page_title="K-Atlas Agent Performance Scorer", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Agent Performance Scorer")
st.caption("Checkpoint 144 - gerado pelo K-Atlas Local Batch Factory.")
