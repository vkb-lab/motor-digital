...
st.set_page_config(page_title="K-Atlas K-Uni Monthly Resource Gate", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Monthly Resource Gate")
st.caption("Checkpoint 492 - gerado pelo K-Atlas Local Batch Factory.")
