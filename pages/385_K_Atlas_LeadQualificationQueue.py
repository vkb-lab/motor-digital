...
from k_atlas.core.lead_qualification_queue.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Lead Qualification Queue", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Lead Qualification Queue")
st.caption("Checkpoint 385 - gerado pelo K-Atlas Local Batch Factory.")
