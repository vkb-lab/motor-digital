...
from k_atlas.core.k_uni_daily_ops_dashboard.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas K-Uni Daily Ops Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Daily Ops Dashboard")
st.caption("Checkpoint 478 - gerado pelo K-Atlas Local Batch Factory.")
