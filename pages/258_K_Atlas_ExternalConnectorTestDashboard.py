...
from k_atlas.core.external_connector_test_dashboard.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas External Connector Test Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas External Connector Test Dashboard")
st.caption("Checkpoint 258 - gerado pelo K-Atlas Local Batch Factory.")
