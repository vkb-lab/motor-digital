...
st.set_page_config(page_title="K-Atlas K-Uni Page Health Scanner", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Page Health Scanner")
st.caption("Checkpoint 516 - gerado pelo K-Atlas Local Batch Factory.")
