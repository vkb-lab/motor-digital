...
from k_atlas.core.k_uni_session_warmup_runner.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas K-Uni Session Warmup Runner", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Session Warmup Runner")
st.caption("Checkpoint 531 - gerado pelo K-Atlas Local Batch Factory.")
