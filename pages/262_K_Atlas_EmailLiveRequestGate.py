...
from k_atlas.core.email_live_request_gate.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Email Live Request Gate", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Email Live Request Gate")
st.caption("Checkpoint 262 - gerado pelo K-Atlas Local Batch Factory.")
