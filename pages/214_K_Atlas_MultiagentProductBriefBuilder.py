...
st.set_page_config(page_title="K-Atlas Multiagent Product Brief Builder", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Multiagent Product Brief Builder")
st.caption("Checkpoint 214 - gerado pelo K-Atlas Local Batch Factory.")
