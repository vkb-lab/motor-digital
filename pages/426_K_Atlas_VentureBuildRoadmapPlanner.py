...
st.set_page_config(page_title="K-Atlas Venture Build Roadmap Planner", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Venture Build Roadmap Planner")
st.caption("Checkpoint 426 - gerado pelo K-Atlas Local Batch Factory.")
