...
st.set_page_config(page_title="K-Atlas K-Uni Business Execution Queue", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Business Execution Queue")
st.caption("Checkpoint 457 - gerado pelo K-Atlas Local Batch Factory.")
