...
from k_atlas.core.external_live_execution_queue.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas External Live Execution Queue", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas External Live Execution Queue")
st.caption("Checkpoint 271 - gerado pelo K-Atlas Local Batch Factory.")
