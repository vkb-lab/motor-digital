...
from k_atlas.core.k_uni_quarterly_ops_dashboard.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas K-Uni Quarterly Ops Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Quarterly Ops Dashboard")
st.caption("Checkpoint 498 - gerado pelo K-Atlas Local Batch Factory.")
