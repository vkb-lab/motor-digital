...
st.set_page_config(page_title="K-Atlas K-Uni Command Center Sync", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Command Center Sync")
st.caption("Checkpoint 517 - gerado pelo K-Atlas Local Batch Factory.")
