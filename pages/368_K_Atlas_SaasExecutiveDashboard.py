...
from k_atlas.core.saas_executive_dashboard.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas SaaS Executive Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas SaaS Executive Dashboard")
st.caption("Checkpoint 368 - gerado pelo K-Atlas Local Batch Factory.")
