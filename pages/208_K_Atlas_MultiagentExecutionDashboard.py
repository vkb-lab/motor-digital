...
st.set_page_config(page_title="K-Atlas Multiagent Execution Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Multiagent Execution Dashboard")
st.caption("Checkpoint 208 - gerado pelo K-Atlas Local Batch Factory.")
