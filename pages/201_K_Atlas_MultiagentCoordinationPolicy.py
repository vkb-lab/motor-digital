...
from k_atlas.core.multiagent_coordination_policy.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Multiagent Coordination Policy", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Multiagent Coordination Policy")
st.caption("Checkpoint 201 - gerado pelo K-Atlas Local Batch Factory.")
