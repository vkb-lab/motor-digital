...
from k_atlas.core.k_uni_operator_launchpad.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas K-Uni Operator Launchpad", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Operator Launchpad")
st.caption("Checkpoint 467 - gerado pelo K-Atlas Local Batch Factory.")
