...
from k_atlas.core.agent_policy_learning_engine.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Agent Policy Learning Engine", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Agent Policy Learning Engine")
st.caption("Checkpoint 174 - gerado pelo K-Atlas Local Batch Factory.")
