...
from k_atlas.core.multiagent_role_registry.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Multiagent Role Registry", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Multiagent Role Registry")
st.caption("Checkpoint 194 - gerado pelo K-Atlas Local Batch Factory.")
