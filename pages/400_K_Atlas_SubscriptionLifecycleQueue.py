...
st.set_page_config(page_title="K-Atlas Subscription Lifecycle Queue", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Subscription Lifecycle Queue")
st.caption("Checkpoint 400 - gerado pelo K-Atlas Local Batch Factory.")
