...
from k_atlas.core.revenue_scale_dashboard.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Revenue Scale Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Revenue Scale Dashboard")
st.caption("Checkpoint 403 - gerado pelo K-Atlas Local Batch Factory.")
