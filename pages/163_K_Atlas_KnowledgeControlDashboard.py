...
from k_atlas.core.knowledge_control_dashboard.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Knowledge Control Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Knowledge Control Dashboard")
st.caption("Checkpoint 163 - gerado pelo K-Atlas Local Batch Factory.")
