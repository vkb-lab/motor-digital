...
from k_atlas.core.multiagent_channel_adapter_registry.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Multiagent Channel Adapter Registry", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Multiagent Channel Adapter Registry")
st.caption("Checkpoint 240 - gerado pelo K-Atlas Local Batch Factory.")
