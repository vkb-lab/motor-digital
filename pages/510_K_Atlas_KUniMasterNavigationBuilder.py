...
from k_atlas.core.k_uni_master_navigation_builder.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas K-Uni Master Navigation Builder", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Master Navigation Builder")
st.caption("Checkpoint 510 - gerado pelo K-Atlas Local Batch Factory.")
