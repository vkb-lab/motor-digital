...
st.set_page_config(page_title="K-Atlas External Live Rollback Plan", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas External Live Rollback Plan")
st.caption("Checkpoint 272 - gerado pelo K-Atlas Local Batch Factory.")
