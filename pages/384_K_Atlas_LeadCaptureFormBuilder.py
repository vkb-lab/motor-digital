...
from k_atlas.core.lead_capture_form_builder.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Lead Capture Form Builder", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Lead Capture Form Builder")
st.caption("Checkpoint 384 - gerado pelo K-Atlas Local Batch Factory.")
