...
st.set_page_config(page_title="K-Atlas SaaS Board Review Gate", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas SaaS Board Review Gate")
st.caption("Checkpoint 366 - gerado pelo K-Atlas Local Batch Factory.")
