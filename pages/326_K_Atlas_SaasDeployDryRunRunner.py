...
st.set_page_config(page_title="K-Atlas SaaS Deploy Dry Run Runner", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas SaaS Deploy Dry Run Runner")
st.caption("Checkpoint 326 - gerado pelo K-Atlas Local Batch Factory.")
