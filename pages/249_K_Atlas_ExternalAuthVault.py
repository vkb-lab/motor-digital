...
from k_atlas.core.external_auth_vault.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas External Auth Vault", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas External Auth Vault")
st.caption("Checkpoint 249 - gerado pelo K-Atlas Local Batch Factory.")
