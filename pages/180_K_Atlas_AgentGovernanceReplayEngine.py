...
from k_atlas.core.agent_governance_replay_engine.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Agent Governance Replay Engine", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Agent Governance Replay Engine")
st.caption("Checkpoint 180 - gerado pelo K-Atlas Local Batch Factory.")
