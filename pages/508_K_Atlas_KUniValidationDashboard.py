...
from k_atlas.core.k_uni_validation_dashboard.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas K-Uni Validation Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Validation Dashboard")
st.caption("Checkpoint 508 - gerado pelo K-Atlas Local Batch Factory.")
