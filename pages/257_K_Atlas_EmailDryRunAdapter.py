...
st.set_page_config(page_title="K-Atlas Email Dry Run Adapter", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Email Dry Run Adapter")
st.caption("Checkpoint 257 - gerado pelo K-Atlas Local Batch Factory.")
