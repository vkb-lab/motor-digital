...
from k_atlas.core.sales_conversation_planner.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Sales Conversation Planner", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Sales Conversation Planner")
st.caption("Checkpoint 389 - gerado pelo K-Atlas Local Batch Factory.")
