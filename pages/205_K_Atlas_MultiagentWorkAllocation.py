...
from k_atlas.core.multiagent_work_allocation.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Multiagent Work Allocation", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Multiagent Work Allocation")
st.caption("Checkpoint 205 - gerado pelo K-Atlas Local Batch Factory.")
