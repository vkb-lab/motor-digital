...
from k_atlas.core.k_uni_operator_handoff_guide.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas K-Uni Operator Handoff Guide", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Operator Handoff Guide")
st.caption("Checkpoint 502 - gerado pelo K-Atlas Local Batch Factory.")
