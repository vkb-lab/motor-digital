...
from k_atlas.core.k_uni_master_launcher_script.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas K-Uni Master Launcher Script", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Master Launcher Script")
st.caption("Checkpoint 519 - gerado pelo K-Atlas Local Batch Factory.")
