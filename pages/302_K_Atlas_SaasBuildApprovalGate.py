...
from k_atlas.core.saas_build_approval_gate.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas SaaS Build Approval Gate", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas SaaS Build Approval Gate")
st.caption("Checkpoint 302 - gerado pelo K-Atlas Local Batch Factory.")
