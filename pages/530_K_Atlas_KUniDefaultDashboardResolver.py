...
st.set_page_config(page_title="K-Atlas K-Uni Default Dashboard Resolver", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Default Dashboard Resolver")
st.caption("Checkpoint 530 - gerado pelo K-Atlas Local Batch Factory.")
