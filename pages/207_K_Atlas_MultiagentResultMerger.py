...
from k_atlas.core.multiagent_result_merger.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Multiagent Result Merger", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Multiagent Result Merger")
st.caption("Checkpoint 207 - gerado pelo K-Atlas Local Batch Factory.")
