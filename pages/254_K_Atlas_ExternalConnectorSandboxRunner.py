...
from k_atlas.core.external_connector_sandbox_runner.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas External Connector Sandbox Runner", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas External Connector Sandbox Runner")
st.caption("Checkpoint 254 - gerado pelo K-Atlas Local Batch Factory.")
