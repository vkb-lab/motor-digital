...
from k_atlas.core.k_uni_mission_control_queue.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas K-Uni Mission Control Queue", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Mission Control Queue")
st.caption("Checkpoint 461 - gerado pelo K-Atlas Local Batch Factory.")
