...
st.set_page_config(page_title="K-Atlas Venture Capital Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Venture Capital Dashboard")
st.caption("Checkpoint 438 - gerado pelo K-Atlas Local Batch Factory.")
