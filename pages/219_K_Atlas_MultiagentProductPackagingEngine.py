...
from k_atlas.core.multiagent_product_packaging_engine.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Multiagent Product Packaging Engine", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Multiagent Product Packaging Engine")
st.caption("Checkpoint 219 - gerado pelo K-Atlas Local Batch Factory.")
