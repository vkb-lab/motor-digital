...
from k_atlas.core.multiagent_product_asset_builder.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Multiagent Product Asset Builder", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Multiagent Product Asset Builder")
st.caption("Checkpoint 220 - gerado pelo K-Atlas Local Batch Factory.")
