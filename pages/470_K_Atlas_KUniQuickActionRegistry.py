...
from k_atlas.core.k_uni_quick_action_registry.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas K-Uni Quick Action Registry", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Quick Action Registry")
st.caption("Checkpoint 470 - gerado pelo K-Atlas Local Batch Factory.")
