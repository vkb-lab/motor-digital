...
from k_atlas.core.saas_expansion_opportunity_detector.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas SaaS Expansion Opportunity Detector", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas SaaS Expansion Opportunity Detector")
st.caption("Checkpoint 352 - gerado pelo K-Atlas Local Batch Factory.")
