...
from k_atlas.core.k_uni_unified_navigation_dashboard.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas K-Uni Unified Navigation Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Unified Navigation Dashboard")
st.caption("Checkpoint 513 - gerado pelo K-Atlas Local Batch Factory.")
