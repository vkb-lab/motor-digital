...
from k_atlas.core.saas_kpi_dashboard_builder.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas SaaS KPI Dashboard Builder", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas SaaS KPI Dashboard Builder")
st.caption("Checkpoint 355 - gerado pelo K-Atlas Local Batch Factory.")
