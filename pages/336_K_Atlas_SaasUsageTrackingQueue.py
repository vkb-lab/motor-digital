...
from k_atlas.core.saas_usage_tracking_queue.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas SaaS Usage Tracking Queue", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas SaaS Usage Tracking Queue")
st.caption("Checkpoint 336 - gerado pelo K-Atlas Local Batch Factory.")
