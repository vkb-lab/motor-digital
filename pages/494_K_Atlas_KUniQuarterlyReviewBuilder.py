...
from k_atlas.core.k_uni_quarterly_review_builder.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas K-Uni Quarterly Review Builder", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Quarterly Review Builder")
st.caption("Checkpoint 494 - gerado pelo K-Atlas Local Batch Factory.")
