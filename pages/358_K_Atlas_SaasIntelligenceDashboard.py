...
from k_atlas.core.saas_intelligence_dashboard.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas SaaS Intelligence Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas SaaS Intelligence Dashboard")
st.caption("Checkpoint 358 - gerado pelo K-Atlas Local Batch Factory.")
