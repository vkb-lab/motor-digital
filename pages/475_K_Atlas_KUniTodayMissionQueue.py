...
st.set_page_config(page_title="K-Atlas K-Uni Today Mission Queue", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Today Mission Queue")
st.caption("Checkpoint 475 - gerado pelo K-Atlas Local Batch Factory.")
