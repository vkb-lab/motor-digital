...
from k_atlas.core.k_uni_unicorn_factory_capsule.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas K-Uni Unicorn Factory Capsule", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Unicorn Factory Capsule")
st.caption("Checkpoint 501 - gerado pelo K-Atlas Local Batch Factory.")
