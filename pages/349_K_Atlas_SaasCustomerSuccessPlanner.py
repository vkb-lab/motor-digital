...
from k_atlas.core.saas_customer_success_planner.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas SaaS Customer Success Planner", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas SaaS Customer Success Planner")
st.caption("Checkpoint 349 - gerado pelo K-Atlas Local Batch Factory.")
