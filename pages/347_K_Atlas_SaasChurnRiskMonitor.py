...
from k_atlas.core.saas_churn_risk_monitor.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas SaaS Churn Risk Monitor", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas SaaS Churn Risk Monitor")
st.caption("Checkpoint 347 - gerado pelo K-Atlas Local Batch Factory.")
