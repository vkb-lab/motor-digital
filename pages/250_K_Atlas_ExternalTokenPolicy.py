...
from k_atlas.core.external_token_policy.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas External Token Policy", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas External Token Policy")
st.caption("Checkpoint 250 - gerado pelo K-Atlas Local Batch Factory.")
