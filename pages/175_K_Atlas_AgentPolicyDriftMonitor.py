...
from k_atlas.core.agent_policy_drift_monitor.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Agent Policy Drift Monitor", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Agent Policy Drift Monitor")
st.caption("Checkpoint 175 - gerado pelo K-Atlas Local Batch Factory.")
