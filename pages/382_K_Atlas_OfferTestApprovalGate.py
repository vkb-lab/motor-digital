...
from k_atlas.core.offer_test_approval_gate.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Offer Test Approval Gate", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Offer Test Approval Gate")
st.caption("Checkpoint 382 - gerado pelo K-Atlas Local Batch Factory.")
