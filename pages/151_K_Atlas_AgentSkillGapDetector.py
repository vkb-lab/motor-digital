...
st.set_page_config(page_title="K-Atlas Agent Skill Gap Detector", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Agent Skill Gap Detector")
st.caption("Checkpoint 151 - gerado pelo K-Atlas Local Batch Factory.")
