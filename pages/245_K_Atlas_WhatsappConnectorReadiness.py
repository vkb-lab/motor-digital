...
from k_atlas.core.whatsapp_connector_readiness.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas WhatsApp Connector Readiness", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas WhatsApp Connector Readiness")
st.caption("Checkpoint 245 - gerado pelo K-Atlas Local Batch Factory.")
