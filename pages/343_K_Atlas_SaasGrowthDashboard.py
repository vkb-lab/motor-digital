...
from k_atlas.core.saas_growth_dashboard.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas SaaS Growth Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas SaaS Growth Dashboard")
st.caption("Checkpoint 343 - gerado pelo K-Atlas Local Batch Factory.")
