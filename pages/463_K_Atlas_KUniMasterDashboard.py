...
from k_atlas.core.k_uni_master_dashboard.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas K-Uni Master Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Master Dashboard")
st.caption("Checkpoint 463 - gerado pelo K-Atlas Local Batch Factory.")
