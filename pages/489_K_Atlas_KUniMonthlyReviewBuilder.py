...
from k_atlas.core.k_uni_monthly_review_builder.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas K-Uni Monthly Review Builder", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Monthly Review Builder")
st.caption("Checkpoint 489 - gerado pelo K-Atlas Local Batch Factory.")
