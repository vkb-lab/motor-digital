...
st.set_page_config(page_title="K-Atlas Multiagent Content Pack Builder", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Multiagent Content Pack Builder")
st.caption("Checkpoint 234 - gerado pelo K-Atlas Local Batch Factory.")
