...
from k_atlas.core.k_uni_master_control_plane.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas K-Uni Master Control Plane", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Master Control Plane")
st.caption("Checkpoint 449 - gerado pelo K-Atlas Local Batch Factory.")
