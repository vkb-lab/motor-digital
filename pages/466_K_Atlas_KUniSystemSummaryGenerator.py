...
st.set_page_config(page_title="K-Atlas K-Uni System Summary Generator", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni System Summary Generator")
st.caption("Checkpoint 466 - gerado pelo K-Atlas Local Batch Factory.")
