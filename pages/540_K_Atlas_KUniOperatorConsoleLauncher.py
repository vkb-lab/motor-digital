...
from k_atlas.core.k_uni_operator_console_launcher.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas K-Uni Operator Console Launcher", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Operator Console Launcher")
st.caption("Checkpoint 540 - gerado pelo K-Atlas Local Batch Factory.")
