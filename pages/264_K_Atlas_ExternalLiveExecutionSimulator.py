...
st.set_page_config(page_title="K-Atlas External Live Execution Simulator", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas External Live Execution Simulator")
st.caption("Checkpoint 264 - gerado pelo K-Atlas Local Batch Factory.")
