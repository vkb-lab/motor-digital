...
from k_atlas.core.k_uni_venture_portfolio_router.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas K-Uni Venture Portfolio Router", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Venture Portfolio Router")
st.caption("Checkpoint 451 - gerado pelo K-Atlas Local Batch Factory.")
