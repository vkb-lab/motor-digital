...
st.set_page_config(page_title="K-Atlas K-Uni Quarterly Resource Plan", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Quarterly Resource Plan")
st.caption("Checkpoint 497 - gerado pelo K-Atlas Local Batch Factory.")
