...
from k_atlas.core.saas_release_approval_gate.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas SaaS Release Approval Gate", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas SaaS Release Approval Gate")
st.caption("Checkpoint 321 - gerado pelo K-Atlas Local Batch Factory.")
