...
from k_atlas.core.agent_escalation_router.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Agent Escalation Router", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Agent Escalation Router")
st.caption("Checkpoint 141 - gerado pelo K-Atlas Local Batch Factory.")
