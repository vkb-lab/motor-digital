...
st.set_page_config(page_title="K-Atlas Multiagent Launch Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Multiagent Launch Dashboard")
st.caption("Checkpoint 223 - gerado pelo K-Atlas Local Batch Factory.")
