...
from k_atlas.core.saas_investor_brief_queue.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas SaaS Investor Brief Queue", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas SaaS Investor Brief Queue")
st.caption("Checkpoint 365 - gerado pelo K-Atlas Local Batch Factory.")
