...
st.set_page_config(page_title="K-Atlas Knowledge Index Builder", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Knowledge Index Builder")
st.caption("Checkpoint 160 - gerado pelo K-Atlas Local Batch Factory.")
