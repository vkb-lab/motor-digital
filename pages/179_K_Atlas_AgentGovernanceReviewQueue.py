...
from k_atlas.core.agent_governance_review_queue.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Agent Governance Review Queue", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Agent Governance Review Queue")
st.caption("Checkpoint 179 - gerado pelo K-Atlas Local Batch Factory.")
