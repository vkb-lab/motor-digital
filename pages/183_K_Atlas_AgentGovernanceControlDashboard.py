...
st.set_page_config(page_title="K-Atlas Agent Governance Control Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Agent Governance Control Dashboard")
st.caption("Checkpoint 183 - gerado pelo K-Atlas Local Batch Factory.")
