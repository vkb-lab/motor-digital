...
from k_atlas.core.multiagent_pricing_planner.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Multiagent Pricing Planner", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Multiagent Pricing Planner")
st.caption("Checkpoint 225 - gerado pelo K-Atlas Local Batch Factory.")
