...
from k_atlas.core.k_uni_open_control_dashboard.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas K-Uni Open Control Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Open Control Dashboard")
st.caption("Checkpoint 533 - gerado pelo K-Atlas Local Batch Factory.")
