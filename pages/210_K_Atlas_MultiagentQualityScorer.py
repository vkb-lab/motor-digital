...
from k_atlas.core.multiagent_quality_scorer.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Multiagent Quality Scorer", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Multiagent Quality Scorer")
st.caption("Checkpoint 210 - gerado pelo K-Atlas Local Batch Factory.")
