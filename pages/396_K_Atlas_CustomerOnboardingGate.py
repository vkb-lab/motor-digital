...
from k_atlas.core.customer_onboarding_gate.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Customer Onboarding Gate", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Customer Onboarding Gate")
st.caption("Checkpoint 396 - gerado pelo K-Atlas Local Batch Factory.")
