...
st.set_page_config(page_title="K-Atlas Audience Test Planner", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Audience Test Planner")
st.caption("Checkpoint 375 - gerado pelo K-Atlas Local Batch Factory.")
