...
from k_atlas.core.external_live_credential_check.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas External Live Credential Check", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas External Live Credential Check")
st.caption("Checkpoint 269 - gerado pelo K-Atlas Local Batch Factory.")
