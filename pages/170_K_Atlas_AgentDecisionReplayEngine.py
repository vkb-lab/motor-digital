...
st.set_page_config(page_title="K-Atlas Agent Decision Replay Engine", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Agent Decision Replay Engine")
st.caption("Checkpoint 170 - gerado pelo K-Atlas Local Batch Factory.")
