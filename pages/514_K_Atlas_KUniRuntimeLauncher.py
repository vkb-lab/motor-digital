...
from k_atlas.core.k_uni_runtime_launcher.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas K-Uni Runtime Launcher", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Runtime Launcher")
st.caption("Checkpoint 514 - gerado pelo K-Atlas Local Batch Factory.")
