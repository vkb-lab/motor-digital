...
from k_atlas.core.multiagent_product_assembly_queue.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Multiagent Product Assembly Queue", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Multiagent Product Assembly Queue")
st.caption("Checkpoint 216 - gerado pelo K-Atlas Local Batch Factory.")
