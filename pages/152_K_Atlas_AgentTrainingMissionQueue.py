...
from k_atlas.core.agent_training_mission_queue.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Agent Training Mission Queue", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Agent Training Mission Queue")
st.caption("Checkpoint 152 - gerado pelo K-Atlas Local Batch Factory.")
