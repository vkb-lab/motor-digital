...
from k_atlas.core.k_uni_active_page_resolver.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas K-Uni Active Page Resolver", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Active Page Resolver")
st.caption("Checkpoint 520 - gerado pelo K-Atlas Local Batch Factory.")
