...
st.set_page_config(page_title="K-Atlas Multiagent Quality Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Multiagent Quality Dashboard")
st.caption("Checkpoint 213 - gerado pelo K-Atlas Local Batch Factory.")
