...
from k_atlas.core.mvp_scope_gate.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas MVP Scope Gate", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas MVP Scope Gate")
st.caption("Checkpoint 297 - gerado pelo K-Atlas Local Batch Factory.")
