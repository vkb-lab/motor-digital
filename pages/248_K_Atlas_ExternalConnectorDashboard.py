...
st.set_page_config(page_title="K-Atlas External Connector Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas External Connector Dashboard")
st.caption("Checkpoint 248 - gerado pelo K-Atlas Local Batch Factory.")
