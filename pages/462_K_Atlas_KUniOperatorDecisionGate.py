...
from k_atlas.core.k_uni_operator_decision_gate.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas K-Uni Operator Decision Gate", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Operator Decision Gate")
st.caption("Checkpoint 462 - gerado pelo K-Atlas Local Batch Factory.")
