...
from k_atlas.core.market_validation_dashboard.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Market Validation Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Market Validation Dashboard")
st.caption("Checkpoint 378 - gerado pelo K-Atlas Local Batch Factory.")
