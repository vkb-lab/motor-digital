...
from k_atlas.core.external_live_recovery_dashboard.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas External Live Recovery Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas External Live Recovery Dashboard")
st.caption("Checkpoint 283 - gerado pelo K-Atlas Local Batch Factory.")
