...
st.set_page_config(page_title="K-Atlas K-Uni Local OS Final Readiness Check", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Local OS Final Readiness Check")
st.caption("Checkpoint 500 - gerado pelo K-Atlas Local Batch Factory.")
