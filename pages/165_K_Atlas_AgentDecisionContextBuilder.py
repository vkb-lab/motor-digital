...
st.set_page_config(page_title="K-Atlas Agent Decision Context Builder", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Agent Decision Context Builder")
st.caption("Checkpoint 165 - gerado pelo K-Atlas Local Batch Factory.")
