...
from k_atlas.core.agent_governance_health_check.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Agent Governance Health Check", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Agent Governance Health Check")
st.caption("Checkpoint 184 - gerado pelo K-Atlas Local Batch Factory.")
