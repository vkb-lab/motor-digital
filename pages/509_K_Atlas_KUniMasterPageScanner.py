...
from k_atlas.core.k_uni_master_page_scanner.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas K-Uni Master Page Scanner", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Master Page Scanner")
st.caption("Checkpoint 509 - gerado pelo K-Atlas Local Batch Factory.")
