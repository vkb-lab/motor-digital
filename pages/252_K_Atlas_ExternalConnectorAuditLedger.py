...
from k_atlas.core.external_connector_audit_ledger.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas External Connector Audit Ledger", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas External Connector Audit Ledger")
st.caption("Checkpoint 252 - gerado pelo K-Atlas Local Batch Factory.")
