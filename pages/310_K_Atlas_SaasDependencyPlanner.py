...
from k_atlas.core.saas_dependency_planner.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas SaaS Dependency Planner", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas SaaS Dependency Planner")
st.caption("Checkpoint 310 - gerado pelo K-Atlas Local Batch Factory.")
