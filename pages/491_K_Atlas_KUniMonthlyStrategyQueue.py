...
st.set_page_config(page_title="K-Atlas K-Uni Monthly Strategy Queue", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Monthly Strategy Queue")
st.caption("Checkpoint 491 - gerado pelo K-Atlas Local Batch Factory.")
