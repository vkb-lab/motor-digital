...
from k_atlas.core.venture_thesis_builder.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Venture Thesis Builder", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Venture Thesis Builder")
st.caption("Checkpoint 424 - gerado pelo K-Atlas Local Batch Factory.")
