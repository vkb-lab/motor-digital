...
from k_atlas.core.sales_funnel_dashboard.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Sales Funnel Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Sales Funnel Dashboard")
st.caption("Checkpoint 393 - gerado pelo K-Atlas Local Batch Factory.")
