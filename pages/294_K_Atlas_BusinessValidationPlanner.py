...
from k_atlas.core.business_validation_planner.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Business Validation Planner", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Business Validation Planner")
st.caption("Checkpoint 294 - gerado pelo K-Atlas Local Batch Factory.")
