...
from k_atlas.core.k_uni_master_release_report.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas K-Uni Master Release Report", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Master Release Report")
st.caption("Checkpoint 499 - gerado pelo K-Atlas Local Batch Factory.")
