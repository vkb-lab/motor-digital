...
st.set_page_config(page_title="K-Atlas Venture Investor Update Queue", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Venture Investor Update Queue")
st.caption("Checkpoint 440 - gerado pelo K-Atlas Local Batch Factory.")
