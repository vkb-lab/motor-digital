...
from k_atlas.core.saas_commercial_ops_dashboard.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas SaaS Commercial Ops Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas SaaS Commercial Ops Dashboard")
st.caption("Checkpoint 353 - gerado pelo K-Atlas Local Batch Factory.")
