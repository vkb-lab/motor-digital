...
st.set_page_config(page_title="K-Atlas K-Uni Brain Decision Router", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Brain Decision Router")
st.caption("Checkpoint 455 - gerado pelo K-Atlas Local Batch Factory.")
