...
st.set_page_config(page_title="K-Atlas SaaS Metrics Collector", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas SaaS Metrics Collector")
st.caption("Checkpoint 354 - gerado pelo K-Atlas Local Batch Factory.")
