...
from k_atlas.core.k_uni_monthly_ops_dashboard.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas K-Uni Monthly Ops Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Monthly Ops Dashboard")
st.caption("Checkpoint 493 - gerado pelo K-Atlas Local Batch Factory.")
