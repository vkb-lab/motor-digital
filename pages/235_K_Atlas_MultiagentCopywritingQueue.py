...
from k_atlas.core.multiagent_copywriting_queue.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Multiagent Copywriting Queue", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Multiagent Copywriting Queue")
st.caption("Checkpoint 235 - gerado pelo K-Atlas Local Batch Factory.")
