...
from k_atlas.core.multiagent_audience_builder.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Multiagent Audience Builder", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Multiagent Audience Builder")
st.caption("Checkpoint 230 - gerado pelo K-Atlas Local Batch Factory.")
