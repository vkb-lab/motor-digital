...
from k_atlas.core.multiagent_content_calendar_queue.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Multiagent Content Calendar Queue", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Multiagent Content Calendar Queue")
st.caption("Checkpoint 231 - gerado pelo K-Atlas Local Batch Factory.")
