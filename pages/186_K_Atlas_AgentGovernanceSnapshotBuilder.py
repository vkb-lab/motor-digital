...
from k_atlas.core.agent_governance_snapshot_builder.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Agent Governance Snapshot Builder", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Agent Governance Snapshot Builder")
st.caption("Checkpoint 186 - gerado pelo K-Atlas Local Batch Factory.")
