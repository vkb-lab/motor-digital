...
from k_atlas.core.venture_portfolio_snapshot_builder.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Venture Portfolio Snapshot Builder", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Venture Portfolio Snapshot Builder")
st.caption("Checkpoint 442 - gerado pelo K-Atlas Local Batch Factory.")
