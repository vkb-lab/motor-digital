...
from k_atlas.core.venture_governance_review.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Venture Governance Review", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Venture Governance Review")
st.caption("Checkpoint 444 - gerado pelo K-Atlas Local Batch Factory.")
