...
from k_atlas.core.instagram_live_execution_stub.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Instagram Live Execution Stub", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Instagram Live Execution Stub")
st.caption("Checkpoint 266 - gerado pelo K-Atlas Local Batch Factory.")
