...
from k_atlas.core.k_uni_master_index_builder.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas K-Uni Master Index Builder", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Master Index Builder")
st.caption("Checkpoint 464 - gerado pelo K-Atlas Local Batch Factory.")
