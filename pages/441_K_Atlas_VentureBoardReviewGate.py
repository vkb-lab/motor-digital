...
from k_atlas.core.venture_board_review_gate.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Venture Board Review Gate", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Venture Board Review Gate")
st.caption("Checkpoint 441 - gerado pelo K-Atlas Local Batch Factory.")
