...
st.set_page_config(page_title="K-Atlas Payment Flow Planner", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Payment Flow Planner")
st.caption("Checkpoint 394 - gerado pelo K-Atlas Local Batch Factory.")
