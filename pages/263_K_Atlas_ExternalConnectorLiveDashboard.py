...
from k_atlas.core.external_connector_live_dashboard.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas External Connector Live Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas External Connector Live Dashboard")
st.caption("Checkpoint 263 - gerado pelo K-Atlas Local Batch Factory.")
