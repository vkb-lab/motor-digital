...
from k_atlas.core.k_uni_operator_focus_mode.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas K-Uni Operator Focus Mode", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Operator Focus Mode")
st.caption("Checkpoint 472 - gerado pelo K-Atlas Local Batch Factory.")
