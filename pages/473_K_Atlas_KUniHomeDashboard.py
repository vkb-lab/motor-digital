...
from k_atlas.core.k_uni_home_dashboard.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas K-Uni Home Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Home Dashboard")
st.caption("Checkpoint 473 - gerado pelo K-Atlas Local Batch Factory.")
