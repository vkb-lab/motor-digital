...
from k_atlas.core.email_live_postcheck.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Email Live Postcheck", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Email Live Postcheck")
st.caption("Checkpoint 277 - gerado pelo K-Atlas Local Batch Factory.")
