...
from k_atlas.core.unicorn_factory_review_gate.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Unicorn Factory Review Gate", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Unicorn Factory Review Gate")
st.caption("Checkpoint 422 - gerado pelo K-Atlas Local Batch Factory.")
