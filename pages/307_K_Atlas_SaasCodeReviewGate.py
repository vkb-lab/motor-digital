...
from k_atlas.core.saas_code_review_gate.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas SaaS Code Review Gate", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas SaaS Code Review Gate")
st.caption("Checkpoint 307 - gerado pelo K-Atlas Local Batch Factory.")
