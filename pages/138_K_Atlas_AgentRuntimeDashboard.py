...
from k_atlas.core.agent_runtime_dashboard.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Agent Runtime Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Agent Runtime Dashboard")
st.caption("Checkpoint 138 - gerado pelo K-Atlas Local Batch Factory.")
