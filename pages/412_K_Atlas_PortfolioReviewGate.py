...
st.set_page_config(page_title="K-Atlas Portfolio Review Gate", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Portfolio Review Gate")
st.caption("Checkpoint 412 - gerado pelo K-Atlas Local Batch Factory.")
