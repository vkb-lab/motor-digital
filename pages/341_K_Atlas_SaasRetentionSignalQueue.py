...
from k_atlas.core.saas_retention_signal_queue.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas SaaS Retention Signal Queue", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas SaaS Retention Signal Queue")
st.caption("Checkpoint 341 - gerado pelo K-Atlas Local Batch Factory.")
