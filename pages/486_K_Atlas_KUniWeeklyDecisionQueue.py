...
from k_atlas.core.k_uni_weekly_decision_queue.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas K-Uni Weekly Decision Queue", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Weekly Decision Queue")
st.caption("Checkpoint 486 - gerado pelo K-Atlas Local Batch Factory.")
