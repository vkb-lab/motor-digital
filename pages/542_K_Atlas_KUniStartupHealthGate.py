...
from k_atlas.core.k_uni_startup_health_gate.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas K-Uni Startup Health Gate", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Startup Health Gate")
st.caption("Checkpoint 542 - gerado pelo K-Atlas Local Batch Factory.")
