...
from k_atlas.core.k_uni_operating_system_dashboard.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas K-Uni Operating System Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Operating System Dashboard")
st.caption("Checkpoint 458 - gerado pelo K-Atlas Local Batch Factory.")
