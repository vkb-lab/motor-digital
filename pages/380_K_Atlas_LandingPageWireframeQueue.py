...
st.set_page_config(page_title="K-Atlas Landing Page Wireframe Queue", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Landing Page Wireframe Queue")
st.caption("Checkpoint 380 - gerado pelo K-Atlas Local Batch Factory.")
