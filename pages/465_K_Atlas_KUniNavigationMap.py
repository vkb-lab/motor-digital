...
from k_atlas.core.k_uni_navigation_map.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas K-Uni Navigation Map", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Navigation Map")
st.caption("Checkpoint 465 - gerado pelo K-Atlas Local Batch Factory.")
