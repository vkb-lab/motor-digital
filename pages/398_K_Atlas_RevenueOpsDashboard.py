...
from k_atlas.core.revenue_ops_dashboard.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Revenue Ops Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Revenue Ops Dashboard")
st.caption("Checkpoint 398 - gerado pelo K-Atlas Local Batch Factory.")
