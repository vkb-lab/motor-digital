...
from k_atlas.core.external_live_human_approval_console.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas External Live Human Approval Console", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas External Live Human Approval Console")
st.caption("Checkpoint 270 - gerado pelo K-Atlas Local Batch Factory.")
