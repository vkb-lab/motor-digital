...
from k_atlas.core.saas_support_intake.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas SaaS Support Intake", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas SaaS Support Intake")
st.caption("Checkpoint 337 - gerado pelo K-Atlas Local Batch Factory.")
