...
from k_atlas.core.multiagent_content_dashboard.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Multiagent Content Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Multiagent Content Dashboard")
st.caption("Checkpoint 238 - gerado pelo K-Atlas Local Batch Factory.")
