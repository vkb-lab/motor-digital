...
from k_atlas.core.agent_evolution_dashboard.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Agent Evolution Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Agent Evolution Dashboard")
st.caption("Checkpoint 148 - gerado pelo K-Atlas Local Batch Factory.")
