...
from k_atlas.core.training_dataset_builder.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Training Dataset Builder", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Training Dataset Builder")
st.caption("Checkpoint 155 - gerado pelo K-Atlas Local Batch Factory.")
