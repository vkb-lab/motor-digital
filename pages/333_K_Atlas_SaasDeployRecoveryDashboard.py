...
from k_atlas.core.saas_deploy_recovery_dashboard.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas SaaS Deploy Recovery Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas SaaS Deploy Recovery Dashboard")
st.caption("Checkpoint 333 - gerado pelo K-Atlas Local Batch Factory.")
