...
st.set_page_config(page_title="K-Atlas Portfolio Control Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Portfolio Control Dashboard")
st.caption("Checkpoint 408 - gerado pelo K-Atlas Local Batch Factory.")
