...
st.set_page_config(page_title="K-Atlas Niche Research Queue", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Niche Research Queue")
st.caption("Checkpoint 370 - gerado pelo K-Atlas Local Batch Factory.")
