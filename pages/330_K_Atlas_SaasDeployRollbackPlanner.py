...
from k_atlas.core.saas_deploy_rollback_planner.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas SaaS Deploy Rollback Planner", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas SaaS Deploy Rollback Planner")
st.caption("Checkpoint 330 - gerado pelo K-Atlas Local Batch Factory.")
