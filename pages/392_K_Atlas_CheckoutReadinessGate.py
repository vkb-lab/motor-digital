...
from k_atlas.core.checkout_readiness_gate.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Checkout Readiness Gate", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Checkout Readiness Gate")
st.caption("Checkpoint 392 - gerado pelo K-Atlas Local Batch Factory.")
