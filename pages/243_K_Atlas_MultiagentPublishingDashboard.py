...
from k_atlas.core.multiagent_publishing_dashboard.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Multiagent Publishing Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Multiagent Publishing Dashboard")
st.caption("Checkpoint 243 - gerado pelo K-Atlas Local Batch Factory.")
