...
from k_atlas.core.portfolio_strategy_dashboard.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Portfolio Strategy Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Portfolio Strategy Dashboard")
st.caption("Checkpoint 413 - gerado pelo K-Atlas Local Batch Factory.")
