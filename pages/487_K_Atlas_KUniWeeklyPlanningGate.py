...
from k_atlas.core.k_uni_weekly_planning_gate.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas K-Uni Weekly Planning Gate", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Weekly Planning Gate")
st.caption("Checkpoint 487 - gerado pelo K-Atlas Local Batch Factory.")
