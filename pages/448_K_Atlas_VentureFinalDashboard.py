...
st.set_page_config(page_title="K-Atlas Venture Final Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Venture Final Dashboard")
st.caption("Checkpoint 448 - gerado pelo K-Atlas Local Batch Factory.")
