...
st.set_page_config(page_title="K-Atlas Knowledge Capture Engine", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Knowledge Capture Engine")
st.caption("Checkpoint 159 - gerado pelo K-Atlas Local Batch Factory.")
