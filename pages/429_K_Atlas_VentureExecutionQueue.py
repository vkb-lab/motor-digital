...
from k_atlas.core.venture_execution_queue.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Venture Execution Queue", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Venture Execution Queue")
st.caption("Checkpoint 429 - gerado pelo K-Atlas Local Batch Factory.")
