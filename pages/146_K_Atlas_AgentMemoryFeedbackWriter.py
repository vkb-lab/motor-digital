...
from k_atlas.core.agent_memory_feedback_writer.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Agent Memory Feedback Writer", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Agent Memory Feedback Writer")
st.caption("Checkpoint 146 - gerado pelo K-Atlas Local Batch Factory.")
