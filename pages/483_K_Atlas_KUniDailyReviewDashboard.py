...
from k_atlas.core.k_uni_daily_review_dashboard.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas K-Uni Daily Review Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Daily Review Dashboard")
st.caption("Checkpoint 483 - gerado pelo K-Atlas Local Batch Factory.")
