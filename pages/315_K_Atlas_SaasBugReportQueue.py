...
from k_atlas.core.saas_bug_report_queue.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas SaaS Bug Report Queue", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas SaaS Bug Report Queue")
st.caption("Checkpoint 315 - gerado pelo K-Atlas Local Batch Factory.")
