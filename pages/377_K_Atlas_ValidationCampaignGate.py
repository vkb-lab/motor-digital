...
from k_atlas.core.validation_campaign_gate.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Validation Campaign Gate", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Validation Campaign Gate")
st.caption("Checkpoint 377 - gerado pelo K-Atlas Local Batch Factory.")
