...
from k_atlas.core.multiagent_shared_memory.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Multiagent Shared Memory", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Multiagent Shared Memory")
st.caption("Checkpoint 200 - gerado pelo K-Atlas Local Batch Factory.")
