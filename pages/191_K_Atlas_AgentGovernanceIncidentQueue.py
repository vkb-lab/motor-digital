...
from k_atlas.core.agent_governance_incident_queue.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Agent Governance Incident Queue", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Agent Governance Incident Queue")
st.caption("Checkpoint 191 - gerado pelo K-Atlas Local Batch Factory.")
