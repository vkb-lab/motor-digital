...
st.set_page_config(page_title="K-Atlas Multiagent Campaign Planner", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Multiagent Campaign Planner")
st.caption("Checkpoint 229 - gerado pelo K-Atlas Local Batch Factory.")
