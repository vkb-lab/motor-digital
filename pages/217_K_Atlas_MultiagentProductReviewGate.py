...
from k_atlas.core.multiagent_product_review_gate.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Multiagent Product Review Gate", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Multiagent Product Review Gate")
st.caption("Checkpoint 217 - gerado pelo K-Atlas Local Batch Factory.")
