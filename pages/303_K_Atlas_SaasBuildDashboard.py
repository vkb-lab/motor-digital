...
from k_atlas.core.saas_build_dashboard.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas SaaS Build Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas SaaS Build Dashboard")
st.caption("Checkpoint 303 - gerado pelo K-Atlas Local Batch Factory.")
