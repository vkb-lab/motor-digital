...
from k_atlas.core.external_live_retry_policy.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas External Live Retry Policy", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas External Live Retry Policy")
st.caption("Checkpoint 280 - gerado pelo K-Atlas Local Batch Factory.")
