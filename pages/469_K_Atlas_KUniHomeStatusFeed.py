...
from k_atlas.core.k_uni_home_status_feed.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas K-Uni Home Status Feed", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Home Status Feed")
st.caption("Checkpoint 469 - gerado pelo K-Atlas Local Batch Factory.")
