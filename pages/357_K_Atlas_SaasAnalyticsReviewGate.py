...
from k_atlas.core.saas_analytics_review_gate.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas SaaS Analytics Review Gate", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas SaaS Analytics Review Gate")
st.caption("Checkpoint 357 - gerado pelo K-Atlas Local Batch Factory.")
