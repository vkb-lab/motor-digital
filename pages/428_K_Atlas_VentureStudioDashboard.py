...
from k_atlas.core.venture_studio_dashboard.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Venture Studio Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Venture Studio Dashboard")
st.caption("Checkpoint 428 - gerado pelo K-Atlas Local Batch Factory.")
