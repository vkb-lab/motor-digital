...
from k_atlas.core.portfolio_opportunity_scorer.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Portfolio Opportunity Scorer", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Portfolio Opportunity Scorer")
st.caption("Checkpoint 405 - gerado pelo K-Atlas Local Batch Factory.")
