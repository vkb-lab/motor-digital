...
from k_atlas.core.saas_qa_dashboard.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas SaaS QA Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas SaaS QA Dashboard")
st.caption("Checkpoint 318 - gerado pelo K-Atlas Local Batch Factory.")
