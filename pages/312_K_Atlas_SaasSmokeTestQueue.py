...
st.set_page_config(page_title="K-Atlas SaaS Smoke Test Queue", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas SaaS Smoke Test Queue")
st.caption("Checkpoint 312 - gerado pelo K-Atlas Local Batch Factory.")
