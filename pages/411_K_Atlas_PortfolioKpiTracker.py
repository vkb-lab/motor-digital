...
from k_atlas.core.portfolio_kpi_tracker.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Portfolio KPI Tracker", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Portfolio KPI Tracker")
st.caption("Checkpoint 411 - gerado pelo K-Atlas Local Batch Factory.")
