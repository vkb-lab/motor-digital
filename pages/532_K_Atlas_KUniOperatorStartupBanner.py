...
from k_atlas.core.k_uni_operator_startup_banner.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas K-Uni Operator Startup Banner", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Operator Startup Banner")
st.caption("Checkpoint 532 - gerado pelo K-Atlas Local Batch Factory.")
