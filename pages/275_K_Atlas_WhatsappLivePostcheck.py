...
st.set_page_config(page_title="K-Atlas WhatsApp Live Postcheck", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas WhatsApp Live Postcheck")
st.caption("Checkpoint 275 - gerado pelo K-Atlas Local Batch Factory.")
