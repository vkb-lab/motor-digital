...
from k_atlas.core.email_connector_readiness.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Email Connector Readiness", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Email Connector Readiness")
st.caption("Checkpoint 247 - gerado pelo K-Atlas Local Batch Factory.")
