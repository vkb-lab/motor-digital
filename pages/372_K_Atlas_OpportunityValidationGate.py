...
from k_atlas.core.opportunity_validation_gate.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Opportunity Validation Gate", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Opportunity Validation Gate")
st.caption("Checkpoint 372 - gerado pelo K-Atlas Local Batch Factory.")
