...
st.set_page_config(page_title="K-Atlas SaaS Architecture Planner", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas SaaS Architecture Planner")
st.caption("Checkpoint 299 - gerado pelo K-Atlas Local Batch Factory.")
