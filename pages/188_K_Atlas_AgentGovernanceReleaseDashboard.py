...
from k_atlas.core.agent_governance_release_dashboard.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Agent Governance Release Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Agent Governance Release Dashboard")
st.caption("Checkpoint 188 - gerado pelo K-Atlas Local Batch Factory.")
