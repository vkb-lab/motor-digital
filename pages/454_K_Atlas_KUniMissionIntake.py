...
from k_atlas.core.k_uni_mission_intake.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas K-Uni Mission Intake", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Mission Intake")
st.caption("Checkpoint 454 - gerado pelo K-Atlas Local Batch Factory.")
