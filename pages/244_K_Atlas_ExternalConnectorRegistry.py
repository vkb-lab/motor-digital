...
from k_atlas.core.external_connector_registry.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas External Connector Registry", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas External Connector Registry")
st.caption("Checkpoint 244 - gerado pelo K-Atlas Local Batch Factory.")
