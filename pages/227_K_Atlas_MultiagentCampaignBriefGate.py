...
from k_atlas.core.multiagent_campaign_brief_gate.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Multiagent Campaign Brief Gate", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Multiagent Campaign Brief Gate")
st.caption("Checkpoint 227 - gerado pelo K-Atlas Local Batch Factory.")
