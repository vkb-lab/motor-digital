...
st.set_page_config(page_title="K-Atlas Multiagent Offer Builder", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Multiagent Offer Builder")
st.caption("Checkpoint 224 - gerado pelo K-Atlas Local Batch Factory.")
