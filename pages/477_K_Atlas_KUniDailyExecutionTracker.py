...
from k_atlas.core.k_uni_daily_execution_tracker.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas K-Uni Daily Execution Tracker", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Daily Execution Tracker")
st.caption("Checkpoint 477 - gerado pelo K-Atlas Local Batch Factory.")
