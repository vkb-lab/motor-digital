...
from k_atlas.core.upsell_cross_sell_planner.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Upsell Cross Sell Planner", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Upsell Cross Sell Planner")
st.caption("Checkpoint 401 - gerado pelo K-Atlas Local Batch Factory.")
