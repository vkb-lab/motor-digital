...
from k_atlas.core.unicorn_factory_venture_queue.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Unicorn Factory Venture Queue", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Unicorn Factory Venture Queue")
st.caption("Checkpoint 420 - gerado pelo K-Atlas Local Batch Factory.")
