...
from k_atlas.core.k_uni_agent_orchestration_bridge.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas K-Uni Agent Orchestration Bridge", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Agent Orchestration Bridge")
st.caption("Checkpoint 456 - gerado pelo K-Atlas Local Batch Factory.")
