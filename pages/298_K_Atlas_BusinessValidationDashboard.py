...
from k_atlas.core.business_validation_dashboard.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Business Validation Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Business Validation Dashboard")
st.caption("Checkpoint 298 - gerado pelo K-Atlas Local Batch Factory.")
