...
from k_atlas.core.saas_feature_prioritizer.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas SaaS Feature Prioritizer", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas SaaS Feature Prioritizer")
st.caption("Checkpoint 301 - gerado pelo K-Atlas Local Batch Factory.")
