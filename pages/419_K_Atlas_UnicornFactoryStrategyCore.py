...
st.set_page_config(page_title="K-Atlas Unicorn Factory Strategy Core", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Unicorn Factory Strategy Core")
st.caption("Checkpoint 419 - gerado pelo K-Atlas Local Batch Factory.")
