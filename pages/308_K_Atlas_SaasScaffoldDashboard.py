...
from k_atlas.core.saas_scaffold_dashboard.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas SaaS Scaffold Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas SaaS Scaffold Dashboard")
st.caption("Checkpoint 308 - gerado pelo K-Atlas Local Batch Factory.")
