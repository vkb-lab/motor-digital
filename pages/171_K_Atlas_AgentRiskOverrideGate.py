...
st.set_page_config(page_title="K-Atlas Agent Risk Override Gate", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Agent Risk Override Gate")
st.caption("Checkpoint 171 - gerado pelo K-Atlas Local Batch Factory.")
