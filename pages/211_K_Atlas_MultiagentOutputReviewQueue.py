...
st.set_page_config(page_title="K-Atlas Multiagent Output Review Queue", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Multiagent Output Review Queue")
st.caption("Checkpoint 211 - gerado pelo K-Atlas Local Batch Factory.")
