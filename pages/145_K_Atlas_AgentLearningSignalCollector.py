...
from k_atlas.core.agent_learning_signal_collector.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Agent Learning Signal Collector", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Agent Learning Signal Collector")
st.caption("Checkpoint 145 - gerado pelo K-Atlas Local Batch Factory.")
