...
from k_atlas.core.multiagent_message_bus.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Multiagent Message Bus", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Multiagent Message Bus")
st.caption("Checkpoint 199 - gerado pelo K-Atlas Local Batch Factory.")
