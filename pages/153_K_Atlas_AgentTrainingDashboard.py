...
from k_atlas.core.agent_training_dashboard.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Agent Training Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Agent Training Dashboard")
st.caption("Checkpoint 153 - gerado pelo K-Atlas Local Batch Factory.")
