...
from k_atlas.core.multiagent_commercial_dashboard.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Multiagent Commercial Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Multiagent Commercial Dashboard")
st.caption("Checkpoint 228 - gerado pelo K-Atlas Local Batch Factory.")
