...
st.set_page_config(page_title="K-Atlas Venture Risk Remediation Queue", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Venture Risk Remediation Queue")
st.caption("Checkpoint 446 - gerado pelo K-Atlas Local Batch Factory.")
