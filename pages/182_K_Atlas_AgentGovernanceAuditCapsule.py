...
from k_atlas.core.agent_governance_audit_capsule.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Agent Governance Audit Capsule", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Agent Governance Audit Capsule")
st.caption("Checkpoint 182 - gerado pelo K-Atlas Local Batch Factory.")
