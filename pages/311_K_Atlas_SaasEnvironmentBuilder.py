...
from k_atlas.core.saas_environment_builder.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas SaaS Environment Builder", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas SaaS Environment Builder")
st.caption("Checkpoint 311 - gerado pelo K-Atlas Local Batch Factory.")
