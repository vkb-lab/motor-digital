...
from k_atlas.core.recurring_revenue_planner.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Recurring Revenue Planner", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Recurring Revenue Planner")
st.caption("Checkpoint 399 - gerado pelo K-Atlas Local Batch Factory.")
