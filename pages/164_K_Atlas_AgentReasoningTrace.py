...
from k_atlas.core.agent_reasoning_trace.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Agent Reasoning Trace", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Agent Reasoning Trace")
st.caption("Checkpoint 164 - gerado pelo K-Atlas Local Batch Factory.")
