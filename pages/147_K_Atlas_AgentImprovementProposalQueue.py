...
from k_atlas.core.agent_improvement_proposal_queue.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Agent Improvement Proposal Queue", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Agent Improvement Proposal Queue")
st.caption("Checkpoint 147 - gerado pelo K-Atlas Local Batch Factory.")
