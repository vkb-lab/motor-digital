...
from k_atlas.core.training_governance_gate.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Training Governance Gate", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Training Governance Gate")
st.caption("Checkpoint 157 - gerado pelo K-Atlas Local Batch Factory.")
