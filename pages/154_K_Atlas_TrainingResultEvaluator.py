...
from k_atlas.core.training_result_evaluator.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Training Result Evaluator", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Training Result Evaluator")
st.caption("Checkpoint 154 - gerado pelo K-Atlas Local Batch Factory.")
