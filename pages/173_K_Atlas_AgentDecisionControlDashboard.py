...
from k_atlas.core.agent_decision_control_dashboard.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Agent Decision Control Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Agent Decision Control Dashboard")
st.caption("Checkpoint 173 - gerado pelo K-Atlas Local Batch Factory.")
