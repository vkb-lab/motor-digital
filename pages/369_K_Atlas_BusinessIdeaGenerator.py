...
from k_atlas.core.business_idea_generator.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Business Idea Generator", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Business Idea Generator")
st.caption("Checkpoint 369 - gerado pelo K-Atlas Local Batch Factory.")
