...
from k_atlas.core.agent_governance_validation_runner.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Agent Governance Validation Runner", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Agent Governance Validation Runner")
st.caption("Checkpoint 189 - gerado pelo K-Atlas Local Batch Factory.")
