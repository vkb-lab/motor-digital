...
from k_atlas.core.business_portfolio_registry.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Business Portfolio Registry", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Business Portfolio Registry")
st.caption("Checkpoint 404 - gerado pelo K-Atlas Local Batch Factory.")
