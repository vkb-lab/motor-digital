...
from k_atlas.core.k_uni_navigation_integrity_check.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas K-Uni Navigation Integrity Check", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Navigation Integrity Check")
st.caption("Checkpoint 506 - gerado pelo K-Atlas Local Batch Factory.")
