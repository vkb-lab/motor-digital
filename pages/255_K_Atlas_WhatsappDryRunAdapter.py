...
from k_atlas.core.whatsapp_dry_run_adapter.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas WhatsApp Dry Run Adapter", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas WhatsApp Dry Run Adapter")
st.caption("Checkpoint 255 - gerado pelo K-Atlas Local Batch Factory.")
