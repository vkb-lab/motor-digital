...
st.set_page_config(page_title="K-Atlas K-Uni Next Day Planner", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Next Day Planner")
st.caption("Checkpoint 482 - gerado pelo K-Atlas Local Batch Factory.")
