...
from k_atlas.core.agent_runtime_registry.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Agent Runtime Registry", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Agent Runtime Registry")
st.caption("Checkpoint 134 - gerado pelo K-Atlas Local Batch Factory.")
