...
st.set_page_config(page_title="K-Atlas Multiagent Orchestration Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Multiagent Orchestration Dashboard")
st.caption("Checkpoint 198 - gerado pelo K-Atlas Local Batch Factory.")
