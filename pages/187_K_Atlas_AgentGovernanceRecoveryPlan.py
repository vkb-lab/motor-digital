...
from k_atlas.core.agent_governance_recovery_plan.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Agent Governance Recovery Plan", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Agent Governance Recovery Plan")
st.caption("Checkpoint 187 - gerado pelo K-Atlas Local Batch Factory.")
