...
st.set_page_config(page_title="K-Atlas Portfolio Resource Allocation Queue", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Portfolio Resource Allocation Queue")
st.caption("Checkpoint 406 - gerado pelo K-Atlas Local Batch Factory.")
