...
from k_atlas.core.multiagent_creative_brief_router.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Multiagent Creative Brief Router", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Multiagent Creative Brief Router")
st.caption("Checkpoint 236 - gerado pelo K-Atlas Local Batch Factory.")
