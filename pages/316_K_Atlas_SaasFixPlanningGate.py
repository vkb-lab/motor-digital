...
from k_atlas.core.saas_fix_planning_gate.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas SaaS Fix Planning Gate", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas SaaS Fix Planning Gate")
st.caption("Checkpoint 316 - gerado pelo K-Atlas Local Batch Factory.")
