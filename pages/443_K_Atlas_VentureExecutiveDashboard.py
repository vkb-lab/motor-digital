...
from k_atlas.core.venture_executive_dashboard.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Venture Executive Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Venture Executive Dashboard")
st.caption("Checkpoint 443 - gerado pelo K-Atlas Local Batch Factory.")
