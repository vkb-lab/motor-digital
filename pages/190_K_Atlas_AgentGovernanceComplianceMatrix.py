...
from k_atlas.core.agent_governance_compliance_matrix.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Agent Governance Compliance Matrix", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Agent Governance Compliance Matrix")
st.caption("Checkpoint 190 - gerado pelo K-Atlas Local Batch Factory.")
