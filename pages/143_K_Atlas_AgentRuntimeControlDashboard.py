...
from k_atlas.core.agent_runtime_control_dashboard.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Agent Runtime Control Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Agent Runtime Control Dashboard")
st.caption("Checkpoint 143 - gerado pelo K-Atlas Local Batch Factory.")
