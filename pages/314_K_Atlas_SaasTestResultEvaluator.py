...
st.set_page_config(page_title="K-Atlas SaaS Test Result Evaluator", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas SaaS Test Result Evaluator")
st.caption("Checkpoint 314 - gerado pelo K-Atlas Local Batch Factory.")
