...
st.set_page_config(page_title="K-Atlas SaaS Revenue Decision Queue", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas SaaS Revenue Decision Queue")
st.caption("Checkpoint 361 - gerado pelo K-Atlas Local Batch Factory.")
