...
st.set_page_config(page_title="K-Atlas SaaS Revenue Insight Builder", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas SaaS Revenue Insight Builder")
st.caption("Checkpoint 342 - gerado pelo K-Atlas Local Batch Factory.")
