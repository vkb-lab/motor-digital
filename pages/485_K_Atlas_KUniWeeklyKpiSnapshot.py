...
st.set_page_config(page_title="K-Atlas K-Uni Weekly KPI Snapshot", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Weekly KPI Snapshot")
st.caption("Checkpoint 485 - gerado pelo K-Atlas Local Batch Factory.")
