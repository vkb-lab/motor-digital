...
from k_atlas.core.agent_risk_classifier.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Agent Risk Classifier", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Agent Risk Classifier")
st.caption("Checkpoint 166 - gerado pelo K-Atlas Local Batch Factory.")
