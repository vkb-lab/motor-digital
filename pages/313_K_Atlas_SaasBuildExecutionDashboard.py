...
from k_atlas.core.saas_build_execution_dashboard.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas SaaS Build Execution Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas SaaS Build Execution Dashboard")
st.caption("Checkpoint 313 - gerado pelo K-Atlas Local Batch Factory.")
