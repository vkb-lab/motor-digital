...
from k_atlas.core.k_uni_wins_losses_tracker.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas K-Uni Wins Losses Tracker", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Wins Losses Tracker")
st.caption("Checkpoint 480 - gerado pelo K-Atlas Local Batch Factory.")
