...
from k_atlas.core.multiagent_correction_planner.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Multiagent Correction Planner", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Multiagent Correction Planner")
st.caption("Checkpoint 212 - gerado pelo K-Atlas Local Batch Factory.")
