...
from k_atlas.core.saas_release_dashboard.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas SaaS Release Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas SaaS Release Dashboard")
st.caption("Checkpoint 323 - gerado pelo K-Atlas Local Batch Factory.")
