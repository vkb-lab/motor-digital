...
from k_atlas.core.k_uni_git_release_snapshot.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas K-Uni Git Release Snapshot", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Git Release Snapshot")
st.caption("Checkpoint 507 - gerado pelo K-Atlas Local Batch Factory.")
