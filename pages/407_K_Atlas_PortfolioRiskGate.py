...
from k_atlas.core.portfolio_risk_gate.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Portfolio Risk Gate", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Portfolio Risk Gate")
st.caption("Checkpoint 407 - gerado pelo K-Atlas Local Batch Factory.")
