...
from k_atlas.core.external_live_postcheck_runner.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas External Live Postcheck Runner", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas External Live Postcheck Runner")
st.caption("Checkpoint 274 - gerado pelo K-Atlas Local Batch Factory.")
