...
from k_atlas.core.lead_magnet_planner.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Lead Magnet Planner", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Lead Magnet Planner")
st.caption("Checkpoint 381 - gerado pelo K-Atlas Local Batch Factory.")
