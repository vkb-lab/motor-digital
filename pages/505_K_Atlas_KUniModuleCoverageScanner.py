...
from k_atlas.core.k_uni_module_coverage_scanner.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas K-Uni Module Coverage Scanner", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Module Coverage Scanner")
st.caption("Checkpoint 505 - gerado pelo K-Atlas Local Batch Factory.")
