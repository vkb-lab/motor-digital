...
st.set_page_config(page_title="K-Atlas SaaS Pricing Experiment Queue", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas SaaS Pricing Experiment Queue")
st.caption("Checkpoint 344 - gerado pelo K-Atlas Local Batch Factory.")
