...
st.set_page_config(page_title="K-Atlas K-Uni Priority Focus Gate", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Priority Focus Gate")
st.caption("Checkpoint 476 - gerado pelo K-Atlas Local Batch Factory.")
