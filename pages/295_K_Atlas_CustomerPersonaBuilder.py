...
from k_atlas.core.customer_persona_builder.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Customer Persona Builder", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Customer Persona Builder")
st.caption("Checkpoint 295 - gerado pelo K-Atlas Local Batch Factory.")
