...
from k_atlas.core.multiagent_command_dashboard.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Multiagent Command Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Multiagent Command Dashboard")
st.caption("Checkpoint 203 - gerado pelo K-Atlas Local Batch Factory.")
