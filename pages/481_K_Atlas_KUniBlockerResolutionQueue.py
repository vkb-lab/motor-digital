...
from k_atlas.core.k_uni_blocker_resolution_queue.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas K-Uni Blocker Resolution Queue", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Blocker Resolution Queue")
st.caption("Checkpoint 481 - gerado pelo K-Atlas Local Batch Factory.")
