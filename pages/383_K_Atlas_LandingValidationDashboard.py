...
from k_atlas.core.landing_validation_dashboard.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Landing Validation Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Landing Validation Dashboard")
st.caption("Checkpoint 383 - gerado pelo K-Atlas Local Batch Factory.")
