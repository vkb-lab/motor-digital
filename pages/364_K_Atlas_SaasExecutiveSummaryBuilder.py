...
from k_atlas.core.saas_executive_summary_builder.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas SaaS Executive Summary Builder", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas SaaS Executive Summary Builder")
st.caption("Checkpoint 364 - gerado pelo K-Atlas Local Batch Factory.")
