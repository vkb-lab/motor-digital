...
from k_atlas.core.saas_cohort_insight_queue.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas SaaS Cohort Insight Queue", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas SaaS Cohort Insight Queue")
st.caption("Checkpoint 356 - gerado pelo K-Atlas Local Batch Factory.")
