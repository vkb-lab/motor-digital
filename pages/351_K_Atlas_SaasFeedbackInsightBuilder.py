...
from k_atlas.core.saas_feedback_insight_builder.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas SaaS Feedback Insight Builder", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas SaaS Feedback Insight Builder")
st.caption("Checkpoint 351 - gerado pelo K-Atlas Local Batch Factory.")
