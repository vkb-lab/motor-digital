...
st.set_page_config(page_title="K-Atlas K-Uni Operator Shortcut Map", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Operator Shortcut Map")
st.caption("Checkpoint 512 - gerado pelo K-Atlas Local Batch Factory.")
