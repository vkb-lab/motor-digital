...
from k_atlas.core.multiagent_execution_planner.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Multiagent Execution Planner", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Multiagent Execution Planner")
st.caption("Checkpoint 204 - gerado pelo K-Atlas Local Batch Factory.")
