...
from k_atlas.core.agent_governance_dashboard.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Agent Governance Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Agent Governance Dashboard")
st.caption("Checkpoint 178 - gerado pelo K-Atlas Local Batch Factory.")
