...
st.set_page_config(page_title="K-Atlas Lead Funnel Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Lead Funnel Dashboard")
st.caption("Checkpoint 388 - gerado pelo K-Atlas Local Batch Factory.")
