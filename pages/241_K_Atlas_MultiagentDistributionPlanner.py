...
from k_atlas.core.multiagent_distribution_planner.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Multiagent Distribution Planner", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Multiagent Distribution Planner")
st.caption("Checkpoint 241 - gerado pelo K-Atlas Local Batch Factory.")
