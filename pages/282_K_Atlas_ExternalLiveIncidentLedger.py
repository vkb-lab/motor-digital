...
from k_atlas.core.external_live_incident_ledger.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas External Live Incident Ledger", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas External Live Incident Ledger")
st.caption("Checkpoint 282 - gerado pelo K-Atlas Local Batch Factory.")
