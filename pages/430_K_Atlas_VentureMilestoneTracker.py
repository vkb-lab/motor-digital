...
st.set_page_config(page_title="K-Atlas Venture Milestone Tracker", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Venture Milestone Tracker")
st.caption("Checkpoint 430 - gerado pelo K-Atlas Local Batch Factory.")
