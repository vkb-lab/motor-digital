...
from k_atlas.core.multiagent_progress_tracker.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Multiagent Progress Tracker", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Multiagent Progress Tracker")
st.caption("Checkpoint 206 - gerado pelo K-Atlas Local Batch Factory.")
