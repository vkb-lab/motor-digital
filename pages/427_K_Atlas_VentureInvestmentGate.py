...
st.set_page_config(page_title="K-Atlas Venture Investment Gate", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Venture Investment Gate")
st.caption("Checkpoint 427 - gerado pelo K-Atlas Local Batch Factory.")
