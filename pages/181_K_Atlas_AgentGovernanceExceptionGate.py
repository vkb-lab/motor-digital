...
from k_atlas.core.agent_governance_exception_gate.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Agent Governance Exception Gate", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Agent Governance Exception Gate")
st.caption("Checkpoint 181 - gerado pelo K-Atlas Local Batch Factory.")
