...
from k_atlas.core.multiagent_product_dashboard.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Multiagent Product Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Multiagent Product Dashboard")
st.caption("Checkpoint 218 - gerado pelo K-Atlas Local Batch Factory.")
