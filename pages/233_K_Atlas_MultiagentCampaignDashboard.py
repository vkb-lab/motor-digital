...
from k_atlas.core.multiagent_campaign_dashboard.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Multiagent Campaign Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Multiagent Campaign Dashboard")
st.caption("Checkpoint 233 - gerado pelo K-Atlas Local Batch Factory.")
