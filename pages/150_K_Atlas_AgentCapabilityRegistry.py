...
from k_atlas.core.agent_capability_registry.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Agent Capability Registry", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Agent Capability Registry")
st.caption("Checkpoint 150 - gerado pelo K-Atlas Local Batch Factory.")
