...
from k_atlas.core.saas_revenue_forecast_planner.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas SaaS Revenue Forecast Planner", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas SaaS Revenue Forecast Planner")
st.caption("Checkpoint 346 - gerado pelo K-Atlas Local Batch Factory.")
