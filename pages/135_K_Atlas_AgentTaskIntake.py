...
from k_atlas.core.agent_task_intake.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Agent Task Intake", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Agent Task Intake")
st.caption("Checkpoint 135 - gerado pelo K-Atlas Local Batch Factory.")
