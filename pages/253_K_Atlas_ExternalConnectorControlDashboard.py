...
from k_atlas.core.external_connector_control_dashboard.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas External Connector Control Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas External Connector Control Dashboard")
st.caption("Checkpoint 253 - gerado pelo K-Atlas Local Batch Factory.")
