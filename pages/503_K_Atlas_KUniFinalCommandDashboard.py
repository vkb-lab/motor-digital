...
from k_atlas.core.k_uni_final_command_dashboard.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas K-Uni Final Command Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Final Command Dashboard")
st.caption("Checkpoint 503 - gerado pelo K-Atlas Local Batch Factory.")
