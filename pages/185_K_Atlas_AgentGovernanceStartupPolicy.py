...
from k_atlas.core.agent_governance_startup_policy.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Agent Governance Startup Policy", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Agent Governance Startup Policy")
st.caption("Checkpoint 185 - gerado pelo K-Atlas Local Batch Factory.")
