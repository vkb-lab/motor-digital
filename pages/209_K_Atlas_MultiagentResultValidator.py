...
from k_atlas.core.multiagent_result_validator.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Multiagent Result Validator", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Multiagent Result Validator")
st.caption("Checkpoint 209 - gerado pelo K-Atlas Local Batch Factory.")
