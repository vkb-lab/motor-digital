...
from k_atlas.core.external_live_control_dashboard.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas External Live Control Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas External Live Control Dashboard")
st.caption("Checkpoint 273 - gerado pelo K-Atlas Local Batch Factory.")
