...
from k_atlas.core.landing_page_copy_builder.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Landing Page Copy Builder", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Landing Page Copy Builder")
st.caption("Checkpoint 379 - gerado pelo K-Atlas Local Batch Factory.")
