...
st.set_page_config(page_title="K-Atlas K-Uni Quarterly KPI Snapshot", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Quarterly KPI Snapshot")
st.caption("Checkpoint 495 - gerado pelo K-Atlas Local Batch Factory.")
