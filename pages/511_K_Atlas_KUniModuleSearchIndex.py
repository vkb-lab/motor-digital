...
st.set_page_config(page_title="K-Atlas K-Uni Module Search Index", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Module Search Index")
st.caption("Checkpoint 511 - gerado pelo K-Atlas Local Batch Factory.")
