...
from k_atlas.core.business_idea_dashboard.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Business Idea Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Business Idea Dashboard")
st.caption("Checkpoint 373 - gerado pelo K-Atlas Local Batch Factory.")
