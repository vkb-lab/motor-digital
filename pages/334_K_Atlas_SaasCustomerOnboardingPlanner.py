...
from k_atlas.core.saas_customer_onboarding_planner.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas SaaS Customer Onboarding Planner", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas SaaS Customer Onboarding Planner")
st.caption("Checkpoint 334 - gerado pelo K-Atlas Local Batch Factory.")
