...
from k_atlas.core.k_uni_open_command_alias.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas K-Uni Open Command Alias", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Open Command Alias")
st.caption("Checkpoint 529 - gerado pelo K-Atlas Local Batch Factory.")
