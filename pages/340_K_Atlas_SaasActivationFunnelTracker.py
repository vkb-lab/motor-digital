...
st.set_page_config(page_title="K-Atlas SaaS Activation Funnel Tracker", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas SaaS Activation Funnel Tracker")
st.caption("Checkpoint 340 - gerado pelo K-Atlas Local Batch Factory.")
