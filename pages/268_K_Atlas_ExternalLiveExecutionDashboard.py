...
from k_atlas.core.external_live_execution_dashboard.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas External Live Execution Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas External Live Execution Dashboard")
st.caption("Checkpoint 268 - gerado pelo K-Atlas Local Batch Factory.")
