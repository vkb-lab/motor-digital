...
from k_atlas.core.venture_compliance_matrix.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Venture Compliance Matrix", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Venture Compliance Matrix")
st.caption("Checkpoint 445 - gerado pelo K-Atlas Local Batch Factory.")
