...
from k_atlas.core.instagram_live_request_gate.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Instagram Live Request Gate", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Instagram Live Request Gate")
st.caption("Checkpoint 261 - gerado pelo K-Atlas Local Batch Factory.")
