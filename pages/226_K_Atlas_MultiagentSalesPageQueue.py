...
from k_atlas.core.multiagent_sales_page_queue.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Multiagent Sales Page Queue", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Multiagent Sales Page Queue")
st.caption("Checkpoint 226 - gerado pelo K-Atlas Local Batch Factory.")
