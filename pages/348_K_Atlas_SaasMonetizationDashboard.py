...
from k_atlas.core.saas_monetization_dashboard.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas SaaS Monetization Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas SaaS Monetization Dashboard")
st.caption("Checkpoint 348 - gerado pelo K-Atlas Local Batch Factory.")
