...
from k_atlas.core.venture_budget_control_queue.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Venture Budget Control Queue", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Venture Budget Control Queue")
st.caption("Checkpoint 435 - gerado pelo K-Atlas Local Batch Factory.")
