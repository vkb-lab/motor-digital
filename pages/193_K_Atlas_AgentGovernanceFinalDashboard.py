...
from k_atlas.core.agent_governance_final_dashboard.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Agent Governance Final Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Agent Governance Final Dashboard")
st.caption("Checkpoint 193 - gerado pelo K-Atlas Local Batch Factory.")
