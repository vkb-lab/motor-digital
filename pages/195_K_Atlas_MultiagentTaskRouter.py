...
from k_atlas.core.multiagent_task_router.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Multiagent Task Router", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Multiagent Task Router")
st.caption("Checkpoint 195 - gerado pelo K-Atlas Local Batch Factory.")
