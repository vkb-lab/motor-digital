...
st.set_page_config(page_title="K-Atlas Agent Retry Policy", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Agent Retry Policy")
st.caption("Checkpoint 140 - gerado pelo K-Atlas Local Batch Factory.")
