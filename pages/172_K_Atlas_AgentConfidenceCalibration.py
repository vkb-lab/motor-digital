...
from k_atlas.core.agent_confidence_calibration.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Agent Confidence Calibration", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Agent Confidence Calibration")
st.caption("Checkpoint 172 - gerado pelo K-Atlas Local Batch Factory.")
