...
from k_atlas.core.k_uni_launcher_dashboard.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas K-Uni Launcher Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Launcher Dashboard")
st.caption("Checkpoint 523 - gerado pelo K-Atlas Local Batch Factory.")
