...
from k_atlas.core.knowledge_freshness_monitor.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Knowledge Freshness Monitor", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Knowledge Freshness Monitor")
st.caption("Checkpoint 162 - gerado pelo K-Atlas Local Batch Factory.")
