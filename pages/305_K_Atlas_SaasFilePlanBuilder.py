...
from k_atlas.core.saas_file_plan_builder.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas SaaS File Plan Builder", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas SaaS File Plan Builder")
st.caption("Checkpoint 305 - gerado pelo K-Atlas Local Batch Factory.")
