...
from k_atlas.core.training_replay_queue.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Training Replay Queue", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Training Replay Queue")
st.caption("Checkpoint 156 - gerado pelo K-Atlas Local Batch Factory.")
