...
from k_atlas.core.problem_solution_fit_analyzer.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Problem Solution Fit Analyzer", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Problem Solution Fit Analyzer")
st.caption("Checkpoint 296 - gerado pelo K-Atlas Local Batch Factory.")
