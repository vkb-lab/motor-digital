...
st.set_page_config(page_title="K-Atlas K-Uni One Command Open", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni One Command Open")
st.caption("Checkpoint 524 - gerado pelo K-Atlas Local Batch Factory.")
