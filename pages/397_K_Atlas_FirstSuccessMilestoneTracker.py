...
st.set_page_config(page_title="K-Atlas First Success Milestone Tracker", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas First Success Milestone Tracker")
st.caption("Checkpoint 397 - gerado pelo K-Atlas Local Batch Factory.")
