...
from k_atlas.core.multiagent_publishing_queue.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Multiagent Publishing Queue", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Multiagent Publishing Queue")
st.caption("Checkpoint 239 - gerado pelo K-Atlas Local Batch Factory.")
