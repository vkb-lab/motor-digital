...
from k_atlas.core.landing_page_brief_queue.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Landing Page Brief Queue", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Landing Page Brief Queue")
st.caption("Checkpoint 376 - gerado pelo K-Atlas Local Batch Factory.")
