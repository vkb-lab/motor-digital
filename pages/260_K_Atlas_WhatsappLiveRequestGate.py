...
st.set_page_config(page_title="K-Atlas WhatsApp Live Request Gate", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas WhatsApp Live Request Gate")
st.caption("Checkpoint 260 - gerado pelo K-Atlas Local Batch Factory.")
