...
from k_atlas.core.venture_capital_allocation_planner.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Venture Capital Allocation Planner", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Venture Capital Allocation Planner")
st.caption("Checkpoint 434 - gerado pelo K-Atlas Local Batch Factory.")
