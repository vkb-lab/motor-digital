...
st.set_page_config(page_title="K-Atlas Training Control Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Training Control Dashboard")
st.caption("Checkpoint 158 - gerado pelo K-Atlas Local Batch Factory.")
