...
from k_atlas.core.external_connector_live_request_queue.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas External Connector Live Request Queue", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas External Connector Live Request Queue")
st.caption("Checkpoint 259 - gerado pelo K-Atlas Local Batch Factory.")
