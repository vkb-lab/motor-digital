...
st.set_page_config(page_title="K-Atlas Agent Execution Sandbox", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Agent Execution Sandbox")
st.caption("Checkpoint 137 - gerado pelo K-Atlas Local Batch Factory.")
