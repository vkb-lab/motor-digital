...
from k_atlas.core.k_uni_daily_brief_builder.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas K-Uni Daily Brief Builder", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Daily Brief Builder")
st.caption("Checkpoint 474 - gerado pelo K-Atlas Local Batch Factory.")
