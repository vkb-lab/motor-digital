...
st.set_page_config(page_title="K-Atlas Venture Executive Summary Builder", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Venture Executive Summary Builder")
st.caption("Checkpoint 439 - gerado pelo K-Atlas Local Batch Factory.")
