...
from k_atlas.core.k_uni_factory_status_index.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas K-Uni Factory Status Index", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Factory Status Index")
st.caption("Checkpoint 450 - gerado pelo K-Atlas Local Batch Factory.")
