...
from k_atlas.core.revenue_health_gate.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Revenue Health Gate", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Revenue Health Gate")
st.caption("Checkpoint 402 - gerado pelo K-Atlas Local Batch Factory.")
