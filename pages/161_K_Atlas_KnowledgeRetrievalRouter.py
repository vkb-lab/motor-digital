...
from k_atlas.core.knowledge_retrieval_router.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Knowledge Retrieval Router", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Knowledge Retrieval Router")
st.caption("Checkpoint 161 - gerado pelo K-Atlas Local Batch Factory.")
