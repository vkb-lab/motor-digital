...
from k_atlas.core.agent_reasoning_dashboard.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Agent Reasoning Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Agent Reasoning Dashboard")
st.caption("Checkpoint 168 - gerado pelo K-Atlas Local Batch Factory.")
