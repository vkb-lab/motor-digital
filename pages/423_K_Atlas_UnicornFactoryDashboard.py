...
from k_atlas.core.unicorn_factory_dashboard.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Unicorn Factory Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Unicorn Factory Dashboard")
st.caption("Checkpoint 423 - gerado pelo K-Atlas Local Batch Factory.")
