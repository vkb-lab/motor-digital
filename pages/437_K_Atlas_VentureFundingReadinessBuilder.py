...
from k_atlas.core.venture_funding_readiness_builder.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Venture Funding Readiness Builder", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Venture Funding Readiness Builder")
st.caption("Checkpoint 437 - gerado pelo K-Atlas Local Batch Factory.")
