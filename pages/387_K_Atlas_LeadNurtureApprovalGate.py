...
from k_atlas.core.lead_nurture_approval_gate.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Lead Nurture Approval Gate", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Lead Nurture Approval Gate")
st.caption("Checkpoint 387 - gerado pelo K-Atlas Local Batch Factory.")
