...
from k_atlas.core.agent_confidence_scorer.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Agent Confidence Scorer", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Agent Confidence Scorer")
st.caption("Checkpoint 167 - gerado pelo K-Atlas Local Batch Factory.")
