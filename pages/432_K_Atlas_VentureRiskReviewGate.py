...
st.set_page_config(page_title="K-Atlas Venture Risk Review Gate", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Venture Risk Review Gate")
st.caption("Checkpoint 432 - gerado pelo K-Atlas Local Batch Factory.")
