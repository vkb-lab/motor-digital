...
from k_atlas.core.k_uni_main_console_dashboard.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas K-Uni Main Console Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Main Console Dashboard")
st.caption("Checkpoint 543 - gerado pelo K-Atlas Local Batch Factory.")
