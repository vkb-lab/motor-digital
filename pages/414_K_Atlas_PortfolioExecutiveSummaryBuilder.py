...
st.set_page_config(page_title="K-Atlas Portfolio Executive Summary Builder", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Portfolio Executive Summary Builder")
st.caption("Checkpoint 414 - gerado pelo K-Atlas Local Batch Factory.")
