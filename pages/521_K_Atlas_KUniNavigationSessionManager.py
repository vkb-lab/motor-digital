...
from k_atlas.core.k_uni_navigation_session_manager.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas K-Uni Navigation Session Manager", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Navigation Session Manager")
st.caption("Checkpoint 521 - gerado pelo K-Atlas Local Batch Factory.")
