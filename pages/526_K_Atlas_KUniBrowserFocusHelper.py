...
from k_atlas.core.k_uni_browser_focus_helper.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas K-Uni Browser Focus Helper", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Browser Focus Helper")
st.caption("Checkpoint 526 - gerado pelo K-Atlas Local Batch Factory.")
