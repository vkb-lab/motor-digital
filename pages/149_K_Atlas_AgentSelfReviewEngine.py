...
from k_atlas.core.agent_self_review_engine.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Agent Self Review Engine", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Agent Self Review Engine")
st.caption("Checkpoint 149 - gerado pelo K-Atlas Local Batch Factory.")
