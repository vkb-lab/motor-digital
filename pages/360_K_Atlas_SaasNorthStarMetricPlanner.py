...
from k_atlas.core.saas_north_star_metric_planner.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas SaaS North Star Metric Planner", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas SaaS North Star Metric Planner")
st.caption("Checkpoint 360 - gerado pelo K-Atlas Local Batch Factory.")
