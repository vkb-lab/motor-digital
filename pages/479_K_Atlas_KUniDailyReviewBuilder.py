...
from k_atlas.core.k_uni_daily_review_builder.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas K-Uni Daily Review Builder", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Daily Review Builder")
st.caption("Checkpoint 479 - gerado pelo K-Atlas Local Batch Factory.")
