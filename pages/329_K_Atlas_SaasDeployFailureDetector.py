...
from k_atlas.core.saas_deploy_failure_detector.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas SaaS Deploy Failure Detector", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas SaaS Deploy Failure Detector")
st.caption("Checkpoint 329 - gerado pelo K-Atlas Local Batch Factory.")
