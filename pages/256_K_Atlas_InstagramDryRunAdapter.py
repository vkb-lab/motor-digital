...
from k_atlas.core.instagram_dry_run_adapter.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Instagram Dry Run Adapter", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Instagram Dry Run Adapter")
st.caption("Checkpoint 256 - gerado pelo K-Atlas Local Batch Factory.")
