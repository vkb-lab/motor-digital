...
from k_atlas.core.agent_decision_review_queue.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Agent Decision Review Queue", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Agent Decision Review Queue")
st.caption("Checkpoint 169 - gerado pelo K-Atlas Local Batch Factory.")
