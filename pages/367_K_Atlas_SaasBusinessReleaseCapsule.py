...
from k_atlas.core.saas_business_release_capsule.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas SaaS Business Release Capsule", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas SaaS Business Release Capsule")
st.caption("Checkpoint 367 - gerado pelo K-Atlas Local Batch Factory.")
