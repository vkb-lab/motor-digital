...
from k_atlas.core.k_uni_quarterly_strategy_gate.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas K-Uni Quarterly Strategy Gate", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Quarterly Strategy Gate")
st.caption("Checkpoint 496 - gerado pelo K-Atlas Local Batch Factory.")
