...
st.set_page_config(page_title="K-Atlas Multiagent Consensus Engine", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Multiagent Consensus Engine")
st.caption("Checkpoint 202 - gerado pelo K-Atlas Local Batch Factory.")
