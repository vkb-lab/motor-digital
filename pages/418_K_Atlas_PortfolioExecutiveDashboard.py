...
st.set_page_config(page_title="K-Atlas Portfolio Executive Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Portfolio Executive Dashboard")
st.caption("Checkpoint 418 - gerado pelo K-Atlas Local Batch Factory.")
