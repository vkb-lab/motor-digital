...
from k_atlas.core.instagram_live_postcheck.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Instagram Live Postcheck", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Instagram Live Postcheck")
st.caption("Checkpoint 276 - gerado pelo K-Atlas Local Batch Factory.")
