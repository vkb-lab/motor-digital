...
from k_atlas.core.venture_release_capsule.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Venture Release Capsule", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Venture Release Capsule")
st.caption("Checkpoint 447 - gerado pelo K-Atlas Local Batch Factory.")
