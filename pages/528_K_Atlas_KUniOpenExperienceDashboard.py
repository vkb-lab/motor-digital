...
from k_atlas.core.k_uni_open_experience_dashboard.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas K-Uni Open Experience Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Open Experience Dashboard")
st.caption("Checkpoint 528 - gerado pelo K-Atlas Local Batch Factory.")
