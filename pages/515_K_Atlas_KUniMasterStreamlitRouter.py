...
from k_atlas.core.k_uni_master_streamlit_router.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas K-Uni Master Streamlit Router", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Master Streamlit Router")
st.caption("Checkpoint 515 - gerado pelo K-Atlas Local Batch Factory.")
