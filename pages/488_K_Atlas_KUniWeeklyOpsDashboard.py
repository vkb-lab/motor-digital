...
from k_atlas.core.k_uni_weekly_ops_dashboard.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas K-Uni Weekly Ops Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Weekly Ops Dashboard")
st.caption("Checkpoint 488 - gerado pelo K-Atlas Local Batch Factory.")
