...
st.set_page_config(page_title="K-Atlas SaaS Deployment Plan Queue", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas SaaS Deployment Plan Queue")
st.caption("Checkpoint 320 - gerado pelo K-Atlas Local Batch Factory.")
