...
from k_atlas.core.multiagent_conflict_resolver.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Multiagent Conflict Resolver", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Multiagent Conflict Resolver")
st.caption("Checkpoint 197 - gerado pelo K-Atlas Local Batch Factory.")
