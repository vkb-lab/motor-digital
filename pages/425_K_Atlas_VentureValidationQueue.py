...
from k_atlas.core.venture_validation_queue.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Venture Validation Queue", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Venture Validation Queue")
st.caption("Checkpoint 425 - gerado pelo K-Atlas Local Batch Factory.")
