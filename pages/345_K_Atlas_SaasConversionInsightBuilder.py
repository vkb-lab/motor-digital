...
from k_atlas.core.saas_conversion_insight_builder.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas SaaS Conversion Insight Builder", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas SaaS Conversion Insight Builder")
st.caption("Checkpoint 345 - gerado pelo K-Atlas Local Batch Factory.")
