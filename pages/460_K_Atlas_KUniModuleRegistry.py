...
from k_atlas.core.k_uni_module_registry.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas K-Uni Module Registry", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Module Registry")
st.caption("Checkpoint 460 - gerado pelo K-Atlas Local Batch Factory.")
