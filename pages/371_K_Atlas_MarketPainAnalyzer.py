...
from k_atlas.core.market_pain_analyzer.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Market Pain Analyzer", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Market Pain Analyzer")
st.caption("Checkpoint 371 - gerado pelo K-Atlas Local Batch Factory.")
