...
from k_atlas.core.venture_resource_constraint_gate.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Venture Resource Constraint Gate", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Venture Resource Constraint Gate")
st.caption("Checkpoint 436 - gerado pelo K-Atlas Local Batch Factory.")
