...
st.set_page_config(page_title="K-Atlas Objection Handling Queue", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Objection Handling Queue")
st.caption("Checkpoint 390 - gerado pelo K-Atlas Local Batch Factory.")
