...
st.set_page_config(page_title="K-Atlas Unicorn Factory Resource Planner", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Unicorn Factory Resource Planner")
st.caption("Checkpoint 421 - gerado pelo K-Atlas Local Batch Factory.")
