...
from k_atlas.core.portfolio_roadmap_planner.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Portfolio Roadmap Planner", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Portfolio Roadmap Planner")
st.caption("Checkpoint 409 - gerado pelo K-Atlas Local Batch Factory.")
