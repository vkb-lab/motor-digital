...
st.set_page_config(page_title="K-Atlas Agent Governance Remediation Planner", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Agent Governance Remediation Planner")
st.caption("Checkpoint 192 - gerado pelo K-Atlas Local Batch Factory.")
