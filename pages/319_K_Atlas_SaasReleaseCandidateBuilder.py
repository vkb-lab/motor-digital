...
from k_atlas.core.saas_release_candidate_builder.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas SaaS Release Candidate Builder", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas SaaS Release Candidate Builder")
st.caption("Checkpoint 319 - gerado pelo K-Atlas Local Batch Factory.")
