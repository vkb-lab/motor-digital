...
st.set_page_config(page_title="K-Atlas K-Uni Command Shortcut Queue", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Command Shortcut Queue")
st.caption("Checkpoint 471 - gerado pelo K-Atlas Local Batch Factory.")
