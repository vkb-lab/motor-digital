...
from k_atlas.core.portfolio_experiment_review_gate.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Portfolio Experiment Review Gate", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Portfolio Experiment Review Gate")
st.caption("Checkpoint 416 - gerado pelo K-Atlas Local Batch Factory.")
