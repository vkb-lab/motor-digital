...
from k_atlas.core.k_uni_system_health_monitor.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas K-Uni System Health Monitor", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni System Health Monitor")
st.caption("Checkpoint 459 - gerado pelo K-Atlas Local Batch Factory.")
