...
st.set_page_config(page_title="K-Atlas SaaS Operations Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas SaaS Operations Dashboard")
st.caption("Checkpoint 338 - gerado pelo K-Atlas Local Batch Factory.")
