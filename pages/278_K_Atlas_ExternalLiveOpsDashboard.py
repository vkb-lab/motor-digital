...
st.set_page_config(page_title="K-Atlas External Live Ops Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas External Live Ops Dashboard")
st.caption("Checkpoint 278 - gerado pelo K-Atlas Local Batch Factory.")
