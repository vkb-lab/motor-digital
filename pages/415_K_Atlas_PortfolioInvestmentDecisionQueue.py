...
st.set_page_config(page_title="K-Atlas Portfolio Investment Decision Queue", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Portfolio Investment Decision Queue")
st.caption("Checkpoint 415 - gerado pelo K-Atlas Local Batch Factory.")
