...
st.set_page_config(page_title="K-Atlas K-Uni Final Validation Runner", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Final Validation Runner")
st.caption("Checkpoint 504 - gerado pelo K-Atlas Local Batch Factory.")
