...
from k_atlas.core.proposal_builder.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Proposal Builder", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Proposal Builder")
st.caption("Checkpoint 391 - gerado pelo K-Atlas Local Batch Factory.")
