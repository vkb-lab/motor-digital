...
st.set_page_config(page_title="K-Atlas SaaS Billing Readiness Gate", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas SaaS Billing Readiness Gate")
st.caption("Checkpoint 335 - gerado pelo K-Atlas Local Batch Factory.")
