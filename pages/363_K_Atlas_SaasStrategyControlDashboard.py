...
st.set_page_config(page_title="K-Atlas SaaS Strategy Control Dashboard", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas SaaS Strategy Control Dashboard")
st.caption("Checkpoint 363 - gerado pelo K-Atlas Local Batch Factory.")
