...
from k_atlas.core.agent_governance_feedback_writer.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Agent Governance Feedback Writer", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Agent Governance Feedback Writer")
st.caption("Checkpoint 176 - gerado pelo K-Atlas Local Batch Factory.")
