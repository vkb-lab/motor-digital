...
from k_atlas.core.venture_team_role_planner.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Venture Team Role Planner", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Venture Team Role Planner")
st.caption("Checkpoint 431 - gerado pelo K-Atlas Local Batch Factory.")
