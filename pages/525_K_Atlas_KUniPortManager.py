...
from k_atlas.core.k_uni_port_manager.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas K-Uni Port Manager", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Port Manager")
st.caption("Checkpoint 525 - gerado pelo K-Atlas Local Batch Factory.")
