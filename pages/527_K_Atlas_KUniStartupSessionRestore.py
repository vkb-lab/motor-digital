...
from k_atlas.core.k_uni_startup_session_restore.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas K-Uni Startup Session Restore", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Startup Session Restore")
st.caption("Checkpoint 527 - gerado pelo K-Atlas Local Batch Factory.")
