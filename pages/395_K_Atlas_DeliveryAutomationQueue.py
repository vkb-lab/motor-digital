...
from k_atlas.core.delivery_automation_queue.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Delivery Automation Queue", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Delivery Automation Queue")
st.caption("Checkpoint 395 - gerado pelo K-Atlas Local Batch Factory.")
