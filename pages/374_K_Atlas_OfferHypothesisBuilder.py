...
from k_atlas.core.offer_hypothesis_builder.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Offer Hypothesis Builder", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Offer Hypothesis Builder")
st.caption("Checkpoint 374 - gerado pelo K-Atlas Local Batch Factory.")
