...
from k_atlas.core.external_live_recovery_queue.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas External Live Recovery Queue", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas External Live Recovery Queue")
st.caption("Checkpoint 281 - gerado pelo K-Atlas Local Batch Factory.")
