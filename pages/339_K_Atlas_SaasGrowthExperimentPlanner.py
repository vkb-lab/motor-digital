...
from k_atlas.core.saas_growth_experiment_planner.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas SaaS Growth Experiment Planner", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas SaaS Growth Experiment Planner")
st.caption("Checkpoint 339 - gerado pelo K-Atlas Local Batch Factory.")
