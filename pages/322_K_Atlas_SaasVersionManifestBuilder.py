...
st.set_page_config(page_title="K-Atlas SaaS Version Manifest Builder", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas SaaS Version Manifest Builder")
st.caption("Checkpoint 322 - gerado pelo K-Atlas Local Batch Factory.")
