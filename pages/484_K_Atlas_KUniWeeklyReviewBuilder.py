...
st.set_page_config(page_title="K-Atlas K-Uni Weekly Review Builder", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas K-Uni Weekly Review Builder")
st.caption("Checkpoint 484 - gerado pelo K-Atlas Local Batch Factory.")
