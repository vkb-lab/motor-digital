...
from k_atlas.core.instagram_connector_readiness.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Instagram Connector Readiness", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Instagram Connector Readiness")
st.caption("Checkpoint 246 - gerado pelo K-Atlas Local Batch Factory.")
