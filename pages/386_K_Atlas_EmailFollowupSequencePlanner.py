...
from k_atlas.core.email_followup_sequence_planner.core import KAtlasComponent


st.set_page_config(page_title="K-Atlas Email Followup Sequence Planner", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Email Followup Sequence Planner")
st.caption("Checkpoint 386 - gerado pelo K-Atlas Local Batch Factory.")
