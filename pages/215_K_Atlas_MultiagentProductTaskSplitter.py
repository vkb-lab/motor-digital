...
st.set_page_config(page_title="K-Atlas Multiagent Product Task Splitter", layout="wide")

component = KAtlasComponent()
summary = component.summary()

st.title("K-Atlas Multiagent Product Task Splitter")
st.caption("Checkpoint 215 - gerado pelo K-Atlas Local Batch Factory.")
