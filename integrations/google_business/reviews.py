...
def build_review_reply_payload(client_id: str = "parada_atlantida", reviewer: str = "cliente") -> Dict[str, Any]:
    return {
        "action": "google_business_review_reply",
        "client_id": client_id,
        "reviewer": reviewer,
        "reply": "Obrigado pela avaliacao. Ficamos felizes em fazer parte da sua experiencia.",
        "status": "PENDING_APPROVAL",
        "manual_approval_required": True,
    }


def create_review_reply_dry_run(client_id: str = "parada_atlantida") -> Dict[str, Any]:
    return save_dry_run_receipt("review_reply", client_id, build_review_reply_payload(client_id))
