...
def build_media_payload(client_id: str = "parada_atlantida", media_type: str = "photo") -> Dict[str, Any]:
    return {
        "action": "google_business_media_upload",
        "client_id": client_id,
...
def create_media_dry_run(client_id: str = "parada_atlantida") -> Dict[str, Any]:
    return save_dry_run_receipt("media", client_id, build_media_payload(client_id))
