...
st.set_page_config(page_title="K-Atlas Local Business Copilot", layout="wide")
st.title("K-Atlas Local Business Copilot")
...
st.json(['dashboard', 'lead_capture', 'crm_light', 'campaigns', 'reports', 'admin'])
