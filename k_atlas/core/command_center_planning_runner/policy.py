...
def validate_command_center_planning_payload(payload: Mapping[str, Any]) -> dict[str, Any]:
    ...
    return {
        "ok": len(reasons) == 0,
        "status": "command_center_planning_payload_allowed" if not reasons else "command_center_planning_payload_blocked",
        "reasons": reasons or ["command_center_planning_payload_allowed"],
    }
