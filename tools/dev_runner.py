...
COMMANDS = [
    ...
    {
        "name": "smoke_test_learning_agent",
        "cmd": [sys.executable, "smoke_test_learning_agent.py"],
        "required": True,
    },
    {
    ...
    {
        "name": "smoke_test_prompt_generator",
        "cmd": [sys.executable, "smoke_test_prompt_generator.py"],
        "required": True,
    },
    {
    ...
    {
        "name": "smoke_test_creative_intelligence",
        "cmd": [sys.executable, "smoke_test_creative_intelligence.py"],
        "required": True,
    },
    {
